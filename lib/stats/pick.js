...
module.exports.evenHardish = function (stack) {
	...
	var chancesForHard = .5 // the chances (from 0 to 1) of picking the hardest card instead of trying to even out the number of times each card has been seen.
	// chancesForHard starts out at .5 so that hard and even have equal chances. It changes based on the ehDiscrepancy
